...
######################################################
###ISAI###
@app.route('/soyotracosa')
def index():
    return render_template('botones.html')

@app.route('/procesar-botones', methods=["GET", "POST"])
def procesar_botones():
    if request.method == 'POST':
        if 'boton1' in request.form:
            return render_template("estudiante.html")
        elif 'boton2' in request.form:
            return render_template("estudiante.html")
######################################################
